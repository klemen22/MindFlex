...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameItemList.add(new GameItem("Verbal Memory", R.drawable.wordbook_white100, getResources().getColor(R.color.letter_main), getResources().getColor(R.color.letter_background_dark), letterMemoryDesc, LetterGameActivity.class));
